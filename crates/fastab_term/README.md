...
hooks that print custom OSC ANSI escape codes that `fastab_term` also parses. This
is our mechanism for sending information from the shell to `fastab_term`. We send
these codes to `fastab_term` to:
