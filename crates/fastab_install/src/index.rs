...
impl Serialize for ProductName {
    ...
    {
        match self {
            ProductName::Fastab => serializer.serialize_str(PRODUCT_NAME),
...
impl<'de> Deserialize<'de> for ProductName {
        ...
        D: Deserializer<'de>,
    {
        ...
        match s.as_str() {
            "Fastab" | "Easy Complete" => Ok(ProductName::Fastab),
...
mod tests {
    ...
    fn test_product_name_ser_deser() {
        test_ser_deser!(ProductName, ProductName::Fastab, PRODUCT_NAME);
